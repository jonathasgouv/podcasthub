...
function generateHTML(data) {
  ...
  document.getElementById("content").style.marginTop = document.getElementById("nav").offsetHeight - 100 + 'px';
	page += 1;
}
...
document.addEventListener('DOMContentLoaded', async function() {
  ...
  author_element.innerText = decodeURI(title)
	data = await fetch('https://podcasterbackend.podcaster.repl.co/searchGenre?genreId=' + id);
